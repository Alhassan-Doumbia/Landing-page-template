...
import AboutSectionWithButton from "../Components/AboutSectionWithButton";
import "animate.css/animate.compat.css";
import ScrollAnimation from "react-animate-on-scroll";

function AboutUsView({ children = "blablacar" }) {
  return (
    <>
      <section className="flex flex-col gap-20 px-4 w-full min-h-screen border-2 sm:px-8 md:px-16 lg:px-24 xl:px-32">
        <div
          className="flex flex-col md:flex-row w-full h-fit"
          id="content-Container"
        >
          <div className="w-full md:w-1/2 h-fit flex flex-col justify-start gap-6">
            <ScrollAnimation animateIn="fadeIn" >
              <div>
                <h1 className="text-2xl sm:text-3xl md:text-4xl text-primary font-Lexand font-bold">
                  Introduce your product quickly & effectively
                </h1>
                <p className="text-base sm:text-lg md:text-xl text-secondary">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Molestias fuga laudantium consequatur! Quos libero, facere
                  ipsa placeat deserunt ipsam repellat. Ab enim suscipit at eos
                  quaerat quisquam error fuga eum? Eum blanditiis cum, beatae
                  quaerat vel ad soluta animi aliquam reprehenderit cupiditate
                  dolore alias eligendi quis ipsam. Nulla ipsa sint dolorem
                  repellendus, facere perspiciatis. Tempore blanditiis enim
                  nihil culpa quisquam!
                </p>
              </div>
            </ScrollAnimation>
          ...
          <div
            id="illustration"
            className="w-full md:w-1/2 h-fit flex flex-col items-center justify-start mt-10 md:mt-0"
          >
            {children}
          </div>
        </div>
        ...
        <AboutSection>
          ...
          >
            ...
            />
            <path
              id="uuid-52db3307-ec3e-496d-a5d4-9d1f33ffc652-45-45-44-44-565"
            ...
            />
            <path
              id="uuid-2800d917-a06e-4fc6-b661-0f9df9cadefc-46-46-45-45-566"
